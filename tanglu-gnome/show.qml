...
Presentation
{
    ...
    Slide {
        ...
        Text {
            ...
            text: "<p>Thank you for choosing Tanglu.<br>You've chosen a Linux distribution that is</p>" +
                  ...
                  " <li>Integrated well with the GNOME desktop</li>" +
                  "</ul>" +
    ...
    Slide {
        ...
        Text {
            ...
            wrapMode: Text.WordWrap
            text: "<ul>" +
                  " <li>Firefox, Evolution, Shotwell, LibreOffice and Rhythmbox come pre-installed in Tanglu, so you can get started immediately.</li>" +
                  " <li>Use Firefox to browse the web, Evolution to organize your e-mails and LibreOffice to do your office work.</li>" +
                  " <li>Manage your pictures with Shotwell</li>" +
                  " <li>Listen to musik using Rhythmbox, or install a different mediaplayer from the repositories.</li>" +
                  " <li>Popular proprietary applications such as Skype, Picasa, Google Earth and Steam can be installed with one click.</li>" +
                  "</ul>"
        }
    }
    ...
    Slide {
        ...
        Text {
            ...
            text: "<ul>" +
                  ...
                  " <li>Tanglu uses the GNOME desktop. It's fast, easy to use and lets you focus on the things which are really important without getting in your way while you are working.</li>" +
